...
export default function BlogClient({ posts }: { posts: BlogPost[] }) {
  return (
    <div className="min-h-screen pt-32 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-[#030305] text-[#f0f0f5]">
          ...
          {posts.map((post, idx) => (
            <Link key={post.id} href={`/blog/${post.slug}`} className="block">
              ...
              >
                ...
                <h2 className="text-3xl font-bold font-heading mb-4 tracking-tight group-hover:text-blue-400 transition-colors">
                  {post.title}
                </h2>
