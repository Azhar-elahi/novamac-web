...
export default function HomeClient() {
  ...
  return (
    <div className="bg-[#0B1220] text-[#F8FAFC] min-h-screen pt-4 overflow-hidden relative font-sans">
      ...
      {/* ── 1. HERO SECTION WITH SUBTLE BACKGROUND ART (MAX 3% OPACITY WATERMARKS) ── */}
      <section className="px-6 md:px-12 xl:px-20 pt-6 pb-16 max-w-[1400px] mx-auto relative z-10 border-b border-[#1E2E4A]">
        <RichBackgroundArt mouseX={mouseX} mouseY={mouseY} opacity="opacity-[0.03]" />
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-center relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-gradient-to-r from-[#0F1C33] to-[#091222] border border-[#1E2E4A] border-t-white/10 rounded-full text-xs font-mono tracking-widest text-[#3B82F6] uppercase font-bold shadow-[0_10px_25px_rgba(0,0,0,0.4)] mb-4 sm:mb-6">
            ...
            <p className="text-sm sm:text-base md:text-lg text-[#94A3B8] leading-relaxed mb-6 sm:mb-8 font-normal max-w-xl bg-gradient-to-b from-[#0F1C33]/90 via-[#091222]/95 to-[#050A14] backdrop-blur-md p-5 sm:p-6 rounded-2xl border border-[#1E2E4A] border-t-white/10 shadow-[0_20px_40px_rgba(0,0,0,0.6)]">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
              <Link href="/contact"
                className="inline-flex items-center justify-center gap-3 bg-[#3B82F6] text-white px-7 sm:px-8 py-4 font-black text-xs sm:text-sm tracking-widest uppercase hover:bg-white hover:text-[#0B1220] transition-all duration-300 rounded-full group shadow-[0_10px_30px_rgba(59,130,246,0.35)] text-center">
                Start Your Project
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1.5 transition-transform" />
              </Link>
              <Link href="/work"
                className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#0F1C33] to-[#091222] text-[#F8FAFC] border border-[#1E2E4A] border-t-white/10 px-7 sm:px-8 py-4 font-bold text-xs sm:text-sm tracking-widest uppercase hover:border-[#3B82F6] hover:text-[#3B82F6] hover:shadow-[0_0_25px_rgba(59,130,246,0.25)] transition-all duration-300 rounded-full shadow-md text-center">
                Explore Work
              </Link>
            </div>
          </motion.div>
      ...
      <section className="px-4 sm:px-6 md:px-12 xl:px-20 py-16 sm:py-24 max-w-[1400px] mx-auto relative z-10 overflow-hidden border-b border-[#1E2E4A]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 sm:gap-6 mb-12 sm:mb-16 relative z-10">
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-tight text-[#F8FAFC]">
              Deep Technical Expertise.
            </h2>
          </div>
          <Link href="/services" className="inline-flex items-center gap-2 px-6 py-3.5 bg-gradient-to-r from-[#0F1C33] to-[#091222] border border-[#1E2E4A] border-t-white/10 hover:border-[#3B82F6] text-[#3B82F6] hover:text-white text-xs font-mono font-bold uppercase tracking-wider rounded-full transition-all shadow-md">
      ...
      <section className="px-6 md:px-12 xl:px-20 py-20 sm:py-28 bg-[#0B1220] border-b border-[#1E2E4A] relative overflow-hidden z-10">
        ...
        <div className="max-w-[1400px] mx-auto relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-tight text-[#F8FAFC] mb-4">Our 4-Step Process.</h2>
      ...
      <section className="px-6 md:px-12 xl:px-20 py-28 sm:py-36 text-center relative overflow-hidden bg-[#0B1220]">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="max-w-4xl mx-auto relative z-10">
          <h2 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tight text-[#F8FAFC] mb-6 leading-tight">
            Ready to Build Something Extraordinary?
          </h2>
          <p className="text-base sm:text-xl text-[#94A3B8] mb-10 max-w-2xl mx-auto font-normal">
