    ...
    <main className="bg-[#05060c] text-white min-h-screen">
      ...
      <section className="pt-40 pb-20 px-6 md:px-12 xl:px-20 bg-[#05060c] border-b border-white/10 gradient-mesh">
        <div className="max-w-[1400px] mx-auto">
          <div className="inline-flex items-center gap-2 mb-8 border border-white/10 px-4 py-2 rounded-full bg-white/[0.04] backdrop-blur">
        ...
        <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 gap-16 items-start">
            ...
            {service.techStack && (
              <div className="flex flex-wrap gap-2 mb-10">
                {service.techStack.map((t) => (
                  <span key={t} className="text-[10px] font-mono uppercase tracking-widest px-3 py-1.5 rounded-full border border-white/15 text-white/55">
                    {t}
                  </span>
                ))}
              </div>
          ...
          <div className="card-vibrant rounded-2xl p-8 md:p-10">
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="font-mono text-[10px] uppercase tracking-widest text-white/50">What&apos;s included</span>
            </div>
